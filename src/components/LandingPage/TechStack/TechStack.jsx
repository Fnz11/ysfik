...
const TechStack = () => {
  ...
  return (
    <div ref={sectionRef} id="tech" className="my-[10rem]">
      ...
      <div className=" min-h-[130vh] mt-[7rem] w-screen">
        <div className="flex items-center justify-center w-full relative opacity-[0.6] scale-y-[0.6]">
          ...
          {/* TECH CONTAINER */}
          <>
            <div className="w-[60vw] aspect-square rotate-[45deg] border-4 border-white rounded-md  absolute  left-auto top-0 bg-black   z-[10]"></div>
            <div className="w-[60vw] aspect-square rotate-[45deg] border-4 border-white rounded-md  absolute  left-auto top-[15rem] bg-black z-[9]"></div>
            <div className="w-[60vw] aspect-square rotate-[45deg] border-4 border-white rounded-md  absolute  left-auto top-[30rem] bg-black z-[8]"></div>
            <div className="w-[60vw] aspect-square rotate-[45deg] border-4 border-white rounded-md  absolute  left-auto top-[45rem] bg-black z-[7]"></div>
          </>
        </div>
      </div>
    </div>
