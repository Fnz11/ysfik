  ...
  return (
    <>
      ...
      <div className="fixed aspect-square bottom-8 right-8 z-[20] flex items-center justify-center flex-col gap-5">
        {/* Font */}
        <div className="max-md:hidden relative flex items-center justify-center pointer-events-none">
      ...
      {/* Socials */}
      <div className="fixed aspect-square bottom-8 left-8 z-[20] flex items-start justify-end flex-col gap-2 max-md:hidden">
        {/* Whatsapp */}
